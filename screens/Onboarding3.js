...
export default function Onboarding1({navigation}) {
  ...
  const [board3Focus, setBoard3Focus] = useState(true);
    ...
    <View style={{flex: 1, backgroundColor: '#fff'}}>
      <View
        ...
        <View
          ...
          <Image
            source={require('../assets/images/onboardingimg3.png')}
            resizeMode="contain"
            style={{width: responsiveWidth(110), height: responsiveHeight(130)}}
          />
        </View>
      </View>
      <View
        ...
        <View
          ...
          <Text
            ...
            Define your budget for each category and stay in charge!
          </Text>
        </View>
        <View
          style={{
